                      ...
                      <tbody>
                          <tr style="padding:0">
                              <td align="left" class="m_7304439990103367481content" style="padding:30px 40px;word-break:break-word;border-collapse:collapse!important">
                                  <p style="font-size:14px bold">Hola <strong>${nombre}</strong>,<br>Has solicitado reestablecer tu contraseña.</p>
                                  <p style="font-size:14px">Sigue el siguiente enlace para generar una nueva contraseña: <a href="${process.env.FRONTEND_URL}/olvide-password/${token}" target="_blank"> <div style="text-align: center; margin-top: 20px;">
                                    <a href="${process.env.FRONTEND_URL}/olvide-password/${token}" style="text-decoration: none; ">
